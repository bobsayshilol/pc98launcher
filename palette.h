...
#define PALETTE_UI_MGREY			PALETTES_FREE + PALETTES_RESERVED + 3
#define PALETTE_UI_DGREY			PALETTES_FREE + PALETTES_RESERVED + 4
#define PALETTE_UI_RED			PALETTES_FREE + PALETTES_RESERVED + 5
#define PALETTE_UI_GREEN			PALETTES_FREE + PALETTES_RESERVED + 6
#define PALETTE_UI_BLUE			PALETTES_FREE + PALETTES_RESERVED + 7
#define PALETTE_UI_YELLOW		PALETTES_FREE + PALETTES_RESERVED + 8
#define PALETTE_UI_9				PALETTES_FREE + PALETTES_RESERVED + 9
#define PALETTE_UI_10			PALETTES_FREE + PALETTES_RESERVED + 10
#define PALETTE_UI_11			PALETTES_FREE + PALETTES_RESERVED + 11
#define PALETTE_UI_12			PALETTES_FREE + PALETTES_RESERVED + 12
